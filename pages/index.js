    ...
    <div className="container">
      <div className="w-screen h-screen bg-opacity-85 z-0" id="background">
        <div className="h-auto w-full text-center inline-flex justify-between">
          <img src="https://cdn.discordapp.com/attachments/688296719091367949/916742653264138260/Logo-PianoKing.png" className="h-28 m-4 mr-52"></img>
          <img src="https://cdn.discordapp.com/attachments/915534006810972180/915721298888515644/Logo-Negatif.png" className="h-28 m-4"></img>
        ...
        <div className="flex h-auto w-2/5">
          <img src="https://cdn.discordapp.com/attachments/915534006810972180/916638729622409266/cloud1.png" className="z-10 w-72 h-24 m-10"></img>
        </div>
          ...
          <div className="flex h-auto w-2/5">
            <img src="https://cdn.discordapp.com/attachments/915534006810972180/916638730016686100/cloud2.png" className="z-10 w-48 h-12 absolute right-0 center-0 m-5"></img>
          </div>
        </div>
      </div>
